...
PORT_CFLAGS = -O2 -floop-unroll-and-jam -falign-loops=16 -falign-functions=16 -falign-jumps=16 -mtune=sifive-7-series -mcmodel=medany -static -std=gnu99 -fno-common -nostdlib -nostartfiles -lm -lgcc -T $(PORT_DIR)/link.ld
